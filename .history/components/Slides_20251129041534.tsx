    ...
    <div className="flex flex-row-reverse gap-12 items-stretch justify-start w-full max-w-6xl z-10">
      ...
      <div className={`flex-1 bg-zinc-900 border-2 border-[#3875FF] p-12 relative overflow-hidden group ${isActive ? 'animate-in slide-in-from-left duration-700 delay-200' : 'opacity-0'}`}>
         ...
         <div className="flex justify-between items-start mb-12">
            <h3 className="text-4xl font-black text-white">GenAI 2025</h3>
    ...
    <div className="h-full flex flex-col justify-center items-center bg-black px-8">
      ...
      <div className="flex gap-6 items-center justify-center">
        ...
        <div className="flex flex-col items-center">
          <div className="relative w-[400px] h-[400px] rounded-xl overflow-hidden shadow-2xl border border-zinc-800">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{ backgroundImage: `url('/pics/before01.jpg')` }}
            >
              <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                <span className="text-white text-4xl font-black drop-shadow-xl tracking-tighter">BEFORE</span>
              </div>
            </div>
          </div>
          <p className="mt-4 text-zinc-400 text-center text-sm">قبل از HOMA</p>
        </div>
          ...
          <div className="relative w-[400px] h-[400px] rounded-xl overflow-hidden shadow-2xl border border-zinc-800">
            ...
            >
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                <span className="text-white text-4xl font-black drop-shadow-xl tracking-tighter">AFTER</span>
              </div>
            </div>
          </div>
          <p className="mt-4 text-zinc-400 text-center text-sm">بعد از HOMA</p>
        </div>
      </div>
...
export const RoadmapSlide: React.FC<SlideProps> = ({ isActive }) => (
  <div className="h-full flex flex-col justify-center items-center bg-black overflow-hidden relative" dir="rtl">
    ...
    <div className="w-[85%] relative h-[500px] flex items-center">
       ...
       <div className={`absolute right-[8%] w-[25%] ${isActive ? 'animate-in slide-in-from-bottom-8 duration-700 delay-200' : 'opacity-0'}`}>
          ...
          <div className="absolute bottom-[calc(50%+40px)] left-1/2 -translate-x-1/2 w-full text-center">
          ...
          {/* Vertical Connector */}
          <div className="absolute bottom-[50%] left-1/2 -translate-x-1/2 w-[2px] h-[40px] bg-[#2D6BFF] translate-y-[2px]"></div>

          {/* Dot ON the horizontal line */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 bg-[#2D6BFF] rounded-full shadow-[0_0_20px_#2D6BFF] border-4 border-black z-10"></div>
       </div>
       ...
       <div className={`absolute right-[41%] w-[25%] ${isActive ? 'animate-in slide-in-from-top-8 duration-700 delay-400' : 'opacity-0'}`}>
          ...
          {/* Dot ON the horizontal line */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5 bg-zinc-500 rounded-full border-4 border-black z-10"></div>

          {/* Vertical Connector */}
          <div className="absolute top-[50%] left-1/2 -translate-x-1/2 w-[2px] h-[40px] bg-zinc-700 translate-y-[2px]"></div>

          {/* Content Box - Below the line */}
          <div className="absolute top-[calc(50%+40px)] left-1/2 -translate-x-1/2 w-full text-center">
             <div className="text-zinc-500 font-black text-4xl mb-2">Q3 – Q4</div>
             <div className="bg-zinc-800 text-zinc-400 px-4 py-1 text-sm font-bold uppercase tracking-widest inline-block mb-6 rounded-sm border border-zinc-700">Growth</div>
             ...
             <div className="text-zinc-500 text-sm uppercase tracking-widest">تست محصول</div>
          </div>
       </div>
       ...
       <div className={`absolute left-[8%] w-[28%] ${isActive ? 'animate-in slide-in-from-bottom-8 duration-700 delay-600' : 'opacity-0'}`}>
          ...
          <div className="absolute bottom-[calc(50%+40px)] left-1/2 -translate-x-1/2 w-full text-center">
             ...
             <div className="text-white font-bold text-2xl mb-2">تکمیل زنجیره طراحی تا خرید</div>
          ...
          {/* Vertical Connector */}
          <div className="absolute bottom-[50%] left-1/2 -translate-x-1/2 w-[2px] h-[40px] bg-zinc-800 border-l-2 border-dashed border-zinc-600 translate-y-[2px]"></div>

          {/* Dot ON the horizontal line */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5 bg-zinc-700 rounded-full border-4 border-black z-10"></div>
       </div>
...
export const TractionSlide: React.FC<SlideProps> = ({ isActive }) => (
  <div className="h-full w-full flex bg-black">
    ...
    <div className="w-[50%] h-full bg-[#0D0D0D] p-12 flex flex-col justify-between">
      ...
      <div className={`h-[58%] rounded-2xl relative overflow-hidden group border-2 border-green-500/50 shadow-[0_0_30px_rgba(34,197,94,0.1)] ${isActive ? 'animate-in slide-in-from-left duration-700 delay-100' : 'opacity-0'}`}>
         ...
         <div className="relative z-10 p-8 h-full flex flex-col justify-end items-end text-right">
             ...
             <h3 className="text-3xl font-black text-white mb-2">فروشگاه امیر</h3>
         ...
         {[1, 2, 3].map((i) => (
           <div key={i} className="flex-1 bg-zinc-900/50 border border-zinc-800 rounded-xl px-6 flex items-center justify-between hover:bg-zinc-800/80 transition-colors">
              ...
              <div className="text-right">
                 <div className="text-white font-bold text-lg">فروشگاه منتخب #{i}</div>
              </div>
           </div>
         ))}
      </div>
