...
export const GTMSlide: React.FC<SlideProps> = ({ isActive }) => {
  ...
  return (
    <div className="h-full flex flex-col justify-center items-center bg-black">
      ...
      <div className="relative w-[1200px] h-[700px] rounded-xl overflow-hidden shadow-2xl border border-zinc-800">
        ...
        <div
          className="absolute inset-0 bg-contain bg-center border-r-4 border-white"
          style={{
            backgroundImage: `url('/pics/before.webp')`,
